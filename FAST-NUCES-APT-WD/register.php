                ...
                <div class="card-body">
                  ...
                  <form id="registration-form" class="row g-3 needs-validation" action="_partials/_user.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="user_email" title="Please enter a valid Email address!" class="form-control" id="user-email" required>
                      <div class="invalid-feedback">Please enter a valid Email adddress!</div>
                    </div>
<div class="col-12">
  <label for="password" class="form-label">Your password</label>
  <div class="input-group transparent-append">
    <input type="password" class="form-control"  title="Please enter  password at least 6 characters long and contains at least 1 uppercase,1 lowercase letter,1 number!" name="user_password" id="user-password" placeholder="Choose a safe one.." required>
