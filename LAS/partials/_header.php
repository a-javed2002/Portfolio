	...
	<div class="chatbox">
		...
		<div class="custom-tab-1">
			<ul class="nav nav-tabs">
				...
				<li class="nav-item">
					<a class="nav-link" data-bs-toggle="tab" href="#alerts" id="contacted-tab">Alerts</a>
				</li>
				<li class="nav-item">
				...
				<div class="tab-pane fade active show" id="chat" role="tabpanel">
					<div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
						<div class="card-header chat-list-header text-center">
							...
							<div>
								<h6 class="mb-1">ALL Chat List (<?php #echo $rows 
																?>)</h6>
				...
				<div class="tab-pane fade" id="alerts" role="tabpanel">
					<div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
						...
						<div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body1">
							<ul class="contacts" id="recently-contacted">
				...
				<div class="tab-pane fade" id="notes" role="tabpanel">
					<div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
						...
						<div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body2">
							<ul class="contacts" id="online-users">
				...
				$.ajax({
					...
					success: function(data) {
						...
						$('#conversation ').animate({
							scrollTop: $('#conversation div:last-child').position().top
						}, 'slow');
					},
				});
			});
					...
					<ul class="navbar-nav header-right">
						...
						<li class="nav-item dropdown notification_dropdown">
							<a class="nav-link bell bell-link" href="#">
								...
								<span class="badge light text-white bg-primary" id="unseen-msg">
									<!-- unseen messages total -->
								</span>
							</a>
						</li>
						<!-- <li class="nav-item dropdown notification_dropdown">
